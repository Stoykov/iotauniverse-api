...
RUN apt-get update && apt-get install -y nginx php7.0 php7.0-bcmath php7.0-bz2 php7.0-curl php7.0-gd php7.0-intl php7.0-json php7.0-ldap php7.0-mbstring php7.0-mcrypt php7.0-mysql php7.0-opcache php7.0-xml php7.0-sqlite3 php7.0-pspell php7.0-zip supervisor
